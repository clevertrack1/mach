...
- [Nested Routes Example](../_examples/nested-routes/main.go) - Demonstrates deeply nested route groups
- [REST API Example](../_examples/rest-api/main.go) - Full CRUD with route groups
