...
Mach includes ready-to-run examples in the `_examples` directory:

| Example | Description |
|---------|-------------|
| [basic](../_examples/basic/main.go) | Simple hello world with JSON responses |
| [rest-api](../_examples/rest-api/main.go) | Full CRUD REST API with route groups |
| [middleware](../_examples/middleware/main.go) | Custom middleware patterns |
| [file-upload](../_examples/file-upload/main.go) | Handle multipart file uploads |
| [file-download](../_examples/file-download/main.go) | Download, stream, and serve static files |
| [nested-routes](../_examples/nested-routes/main.go) | Nested route groups structure |
